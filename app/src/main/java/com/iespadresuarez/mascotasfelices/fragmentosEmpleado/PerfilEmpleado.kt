...
class PerfilEmpleado : Fragment() {
    ...
    private fun mostrarDatosEmpleado(empleado: Empleado?) {
        ...
        tipoEmpleado.setText(empleado.tipoEmpleado, false)
        edtxtDireccion.setText(empleado.direccion)
        edtxtTelefono.setText(empleado.telefono)

        when (empleado.tipoEmpleado) {
            "Cuidador" -> {
                val salario = getString(R.string.salarioFormato, empleado.salario)
                edtxtSalario.setText(salario)
                txtSalario.visibility = View.VISIBLE
                txtPagoHora.visibility = View.GONE
            }

            "Paseador" -> {
                val pagoHora = getString(R.string.pagoHoraFormato, empleado.pagoHora)
                edtxtPagoHora.setText(pagoHora)
    ...
    companion object {
         ...
         * @return A new instance of fragment PerfilEmpleado.
         */
        // TODO: Rename and change types and number of parameters
        @JvmStatic
        fun newInstance(param1: String, param2: String) =
            PerfilEmpleado().apply {
